...
export function SceneCard({ thread, projectId, isGenerating }: SceneCardProps) {
  ...
  return (
    <motion.div
      ...
      className="group relative overflow-hidden rounded-lg border border-black/20 bg-white/75 p-0 text-left transition-all hover:border-black/40 hover:bg-white/90"
    >
      <Link
